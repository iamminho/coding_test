...
public class 양궁_대회 {
    ...
    public static int scoreDiff(int[] apeach, int[] ryan) {
        int diff = 0;
    ...
    public static boolean isPrior(int[] base, int[] comp) {
        for (int i = 10; i >= 0; i--) {
    ...
    public static int[] ryan(int index, int[] hits, int n, int[] apeach) {
